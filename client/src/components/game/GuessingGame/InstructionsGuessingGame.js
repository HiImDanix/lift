...
function InstructionsGuessingGame(props) {
    return (
        <>
            ...
            <p className="text-center">The game will start in <span className={"text-danger"}><Countdown date={props.startTime}
                                                                         renderer={SecondsCountdownRenderer} /></span> seconds
            </p>
